<?php
/**
 * Catch Starter Theme Options Sanitization Functions
 *
 ...
 */
function catch_starter_sanitize_select( $input, $setting ) {
 ...
 */
function catch_starter_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_starter_sanitize_post( $input ) {
 ...
 */
function catch_starter_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function catch_starter_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function catch_starter_sanitize_number_range( $number, $setting ) {
